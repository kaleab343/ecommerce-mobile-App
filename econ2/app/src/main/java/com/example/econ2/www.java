...
public class www extends AppCompatActivity {
    ...
    private static final String[] SERVER_ENDPOINTS = {
            "http://192.168.1.2/chapa/product/payment/",  // Primary local IP
    ...
    private void handleWebhookIntent(Intent intent) {
        ...
        if (data != null && "econ2".equalsIgnoreCase(data.getScheme())) {
            ...
            if (status != null) {
                switch (status.toLowerCase()) {
                    ...
                    default:
                        ...
                        Toast.makeText(this, "ℹ️ Payment Status: " + status, Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(this, "No status received in webhook.", Toast.LENGTH_LONG).show();
            }
            ...
            if (url != null && !url.isEmpty()) {
                ...
                Toast.makeText(this, "No URL found to load.", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void checkLatestPaymentStatusWithFallback() {
        ...
        // Show loading toast
        Toast.makeText(this, "⏳ Checking latest payment...", Toast.LENGTH_SHORT).show();
    ...
    private class PaymentStatusTaskWithFallback extends AsyncTask<String, Void, PaymentStatusResult> {
        ...
        protected void onPostExecute(PaymentStatusResult result) {
            if (result.success && result.response != null) {
                ...
                Toast.makeText(www.this, "❌ Error: Cannot connect to payment server. Please check your network connection.", Toast.LENGTH_LONG).show();
    ...
    private void handlePaymentResponse(String jsonResponse) {
        try {
            ...
            Toast.makeText(this, "Error processing payment response", Toast.LENGTH_LONG).show();
        }
    }
